...
struct jegl_shader_value
{
    ...
    jegl_shader_value(int x, int y)
        : m_type((type)(type::INTEGER2 | type::INIT_VALUE)), m_ref_count(0)
    {
        m_integer2[0] = x;
        m_integer2[1] = y;
    }
    jegl_shader_value(int x, int y, int z)
        : m_type((type)(type::INTEGER3 | type::INIT_VALUE)), m_ref_count(0)
    {
        m_integer3[0] = x;
        m_integer3[1] = y;
        m_integer3[2] = z;
    ...
    jegl_shader_value(int x, int y, int z, int w)
        : m_type((type)(type::INTEGER4 | type::INIT_VALUE)), m_ref_count(0)
    {
        m_integer4[0] = x;
        m_integer4[1] = y;
        m_integer4[2] = z;
    ...
    jegl_shader_value(float x, float y)
        : m_type((type)(type::FLOAT2 | type::INIT_VALUE)), m_ref_count(0)
    {
        m_float2[0] = x;
        m_float2[1] = y;
    }
    jegl_shader_value(float x, float y, float z)
        : m_type((type)(type::FLOAT3 | type::INIT_VALUE)), m_ref_count(0)
    {
        m_float3[0] = x;
        m_float3[1] = y;
        m_float3[2] = z;
    ...
    jegl_shader_value(float x, float y, float z, float w)
        : m_type((type)(type::FLOAT4 | type::INIT_VALUE)), m_ref_count(0)
    {
        m_float4[0] = x;
        m_float4[1] = y;
        m_float4[2] = z;
    ...
    jegl_shader_value(float *data, type typing)
        : m_type((type)(typing | type::INIT_VALUE)), m_ref_count(0)
    {
        if (data)
        {
